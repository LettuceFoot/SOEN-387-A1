...
<%--    </div>--%>
    ...
    <div class="chatActions">
        ...
        <form class="messageSubmit" action="ChatServlet" method="POST">
            ...
            <input class="btn" type="submit" name="chatAction" value="Submit"> <br><br>
            <input class="btn" type="submit" name="chatAction" value="Clear">
            <input class="btn" type="submit" name="chatAction" value="Download">
